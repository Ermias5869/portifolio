...
export default function Header({ basicInfo }: HeaderProps) {
  ...
  return (
    <header className="flex flex-col lg:flex-row lg:items-center justify-between py-2 px-6 lg:px-8 bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#512c64] text-white md:sticky top-0 z-10">
      <div>
